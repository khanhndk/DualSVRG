...
class DualSVRG(Model):
    ...
    def _get_grad_full_pre_calc_rf(self, xn, xn_rf, yn, n, kn):
    ...
    def _fit_loop(self, x, y,
        ...
        for n in range(max_loop):
            ...
            # if (n % 10000) == 0:
            #     print('Finished={}; Percent={}%'.format(n, n*100.0/max_loop))
            ...
            (grad_full, idx_full_runner, loss_full), knt = self._get_grad_full_pre_calc_rf(xnt, xnt_rf, ynt, nt, knt)
            ...
            if (n+1) % self.freq_update_full_model == 0:
                ...
                for i in range(n-self.cache_size+1, n+1):
                    ...
                    (grad_full, idx_full_runner, loss_full), kit_tmp = self._get_grad_full_pre_calc_rf(
                        xit_tmp, xit_rf_tmp, yit_tmp, it, kit_tmp)

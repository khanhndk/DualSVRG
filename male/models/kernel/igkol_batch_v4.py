...
class IGKOL_BATCH_V4(Model):
    ...
    def __init__(self,
                 ...
                 show_loss=True,
                 **kwargs):
        super(IGKOL_BATCH_V4, self).__init__(model_name=model_name, **kwargs)
    ...
    def _init(self):
        super(IGKOL_BATCH_V4, self)._init()

        learning_rate_m = 1 if self.loss_func == IGKOL_BATCH_V4.HINGE else 1.0 / self.smooth_hinge_tau
    ...
    def _get_grad(self, wxn, yn):
        ...
        if self.loss_func == IGKOL_BATCH_V4.HINGE:
            if o < 1-self.smooth_hinge_tau:
                ...
                loss = 0
                grad = 0
        elif self.loss_func == IGKOL_BATCH_V4.LOGISTIC:
            if o < -500:
                grad = 1
                loss = -o
            elif o > 500:
    ...
    def _fit_loop_v1(self, x, y,
        ...
        if self.oracle == IGKOL_BATCH_V4.BUDGET:
    ...
    def _fit_loop(self, x, y,
        ...
        for n in range(max_loop):
            ...
            move_decision[n] = {
                IGKOL_BATCH_V4.BUDGET: self._oracle_budget,
                IGKOL_BATCH_V4.COVERAGE: self._oracle_coverage,
                IGKOL_BATCH_V4.ALWAYS_MOVE: self._oracle_always,
    ...
    def get_params(self, deep=True):
        out = super(IGKOL_BATCH_V4, self).get_params(deep=deep)
        param_names = IGKOL_BATCH_V4._get_param_names()

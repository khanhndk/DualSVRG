...
class IGKOL_ONLINE_V3(Model):
    ...
    def __init__(self,
                 ...
                 show_loss=True,
                 **kwargs):
        super(IGKOL_ONLINE_V3, self).__init__(model_name=model_name, **kwargs)
    ...
    def _init(self):
        super(IGKOL_ONLINE_V3, self)._init()

        learning_rate_m = 1 if self.loss_func == IGKOL_ONLINE_V3.LOGISTIC else 1.0 / self.smooth_hinge_tau
        self.learning_rate = self.learning_rate_scale * np.minimum(
            1.0 / learning_rate_m,
            1.0 / np.abs(24 * learning_rate_m - self.regular_param))
    ...
    def _get_grad(self, wxn, yn):
        ...
        if self.loss_func == IGKOL_ONLINE_V3.HINGE:
            if o < 1-self.smooth_hinge_tau:
                ...
                loss = 0
                grad = 0
        elif self.loss_func == IGKOL_ONLINE_V3.LOGISTIC:
    ...
    def _fit_loop_v1(self, x, y,
        ...
        if self.oracle == IGKOL_ONLINE_V3.BUDGET:
    ...
    def _fit_loop(self, x, y,
        ...
        for n in range(max_loop):
            ...
            move_decision[n] = {
                IGKOL_ONLINE_V3.BUDGET: self._oracle_budget,
                IGKOL_ONLINE_V3.COVERAGE: self._oracle_coverage,
                IGKOL_ONLINE_V3.ALWAYS_MOVE: self._oracle_always,
